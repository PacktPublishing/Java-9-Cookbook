...
import com.packt.cookbook.ch12_memory.walk.Clazz01;
...
public class Chapter12Memory {
    ...
    private static void demo1_FullMemory() {
        int max = 99888999;
        System.out.println("Chapter12Memory.main() is running for " + max + " objects...");
    ...
    private static void demo2_jcmd_diagnostics() {
        int max = 60;
        System.out.println("Chapter12Memory.main() is running for " + max + " minutes...");
        try{
